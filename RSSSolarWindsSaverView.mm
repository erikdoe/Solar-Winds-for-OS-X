...
- (void)startAnimation
{
    ...
    if (isConfiguring_==NO && _view!=nil)
    {
        if (mainScreenOnly_!=NSOnState || mainScreen_==YES)
        {
            ...
            CGLSetParameter(CGLGetCurrentContext(), kCGLCPSwapInterval,&i);
...
- (IBAction)setEmittersValue:(id)sender
{
    ...
    if (tValue<[IBemittersStepper_ minValue])
    {
        tValue=(int) [IBemittersStepper_ minValue];
        [IBemittersStepper_ setIntValue:tValue];
        [IBemittersTextField_ setIntValue:tValue];
    }
    else
    {
        if (tValue>[IBemittersStepper_ maxValue])
        {
            tValue=(int) [IBemittersStepper_ maxValue];
            [IBemittersStepper_ setIntValue:tValue];
            [IBemittersTextField_ setIntValue:tValue];
        }
    }
...
- (IBAction)setParticlesValue:(id)sender
{
    ...
    if (tValue<[IBparticlesStepper_ minValue])
    {
        tValue=(int) [IBparticlesStepper_ minValue];
        [IBparticlesStepper_ setIntValue:tValue];
        [IBparticlesTextField_ setIntValue:tValue];
    }
    else
    {
        if (tValue>[IBparticlesStepper_ maxValue])
        {
            tValue=(int)[IBparticlesStepper_ maxValue];
            [IBparticlesStepper_ setIntValue:tValue];
            [IBparticlesTextField_ setIntValue:tValue];
        }
    }
...
- (IBAction)setWindsValue:(id)sender
{
    ...
    if (tValue<[IBwindsStepper_ minValue])
    {
        tValue=(int)[IBwindsStepper_ minValue];
        [IBwindsStepper_ setIntValue:tValue];
        [IBwindsTextField_ setIntValue:tValue];
    }
    else
    {
        if (tValue>[IBwindsStepper_ maxValue])
        {
            tValue=(int)[IBwindsStepper_ maxValue];
            [IBwindsStepper_ setIntValue:tValue];
            [IBwindsTextField_ setIntValue:tValue];
        }
    }
